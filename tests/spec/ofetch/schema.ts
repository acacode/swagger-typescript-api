...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  pathParams = {
    ...
    pathParamsList: (petId: number, params: RequestParams = {}) =>
      this.request<Emojis>(`/path-params`, {
        method: "GET",
        ...params,
      }),
  };
  ...
  gists = {
    ...
    publicList: (
      ...
      this.request<Gists>(`/gists/public`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    starredList: (
      ...
      this.request<Gists>(`/gists/starred`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    commentsDetail: (id: number, params: RequestParams = {}) =>
      this.request<Comments>(`/gists/${id}/comments`, {
        method: "GET",
        ...params,
      }),
    ...
    commentsCreate: (id: number, body: CommentBody, params: RequestParams = {}) =>
      this.request<Comment>(`/gists/${id}/comments`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    commentsDelete: (id: number, commentId: number, params: RequestParams = {}) =>
      this.request<void>(`/gists/${id}/comments/${commentId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    commentsDetail2: (id: number, commentId: number, params: RequestParams = {}) =>
      this.request<Comment>(`/gists/${id}/comments/${commentId}`, {
        method: "GET",
        ...params,
      }),
    ...
    forksCreate: (id: number, params: RequestParams = {}) =>
      this.request<void>(`/gists/${id}/forks`, {
        method: "POST",
        ...params,
      }),
    ...
    starDelete: (id: number, params: RequestParams = {}) =>
      this.request<void>(`/gists/${id}/star`, {
        method: "DELETE",
        ...params,
      }),
  ...
  gitignore = {
    ...
    templatesList: (params: RequestParams = {}) =>
      this.request<Gitignore>(`/gitignore/templates`, {
        method: "GET",
        ...params,
      }),
    ...
    templatesDetail: (language: string, params: RequestParams = {}) =>
      this.request<GitignoreLang>(`/gitignore/templates/${language}`, {
        method: "GET",
        ...params,
      }),
  };
  ...
  legacy = {
    ...
    issuesSearchDetail: (
      ...
      this.request<SearchIssuesByKeyword>(`/legacy/issues/search/${owner}/${repository}/${state}/${keyword}`, {
        method: "GET",
        ...params,
      }),
    ...
    reposSearchDetail: (
      ...
      this.request<SearchRepositoriesByKeyword>(`/legacy/repos/search/${keyword}`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    userEmailDetail: (email: string, params: RequestParams = {}) =>
      this.request<SearchUserByEmail>(`/legacy/user/email/${email}`, {
        method: "GET",
        ...params,
      }),
    ...
    userSearchDetail: (
      ...
      this.request<SearchUsersByKeyword>(`/legacy/user/search/${keyword}`, {
        method: "GET",
        query: query,
        ...params,
      }),
  ...
  markdown = {
    ...
    postMarkdown: (params: RequestParams = {}) =>
      this.request<void>(`/markdown/raw`, {
        method: "POST",
        ...params,
      }),
  };
  ...
  networks = {
    ...
    eventsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Events>(`/networks/${owner}/${repo}/events`, {
        method: "GET",
        ...params,
      }),
  };
  notifications = {
    ...
    notificationsUpdate: (body: NotificationMarkRead, params: RequestParams = {}) =>
      this.request<void>(`/notifications`, {
        method: "PUT",
        body: body,
        ...params,
      }),
    ...
    threadsDetail: (id: number, params: RequestParams = {}) =>
      this.request<Notifications>(`/notifications/threads/${id}`, {
        method: "GET",
        ...params,
      }),
    ...
    threadsPartialUpdate: (id: number, params: RequestParams = {}) =>
      this.request<void>(`/notifications/threads/${id}`, {
        method: "PATCH",
        ...params,
      }),
    ...
    threadsSubscriptionDelete: (id: number, params: RequestParams = {}) =>
      this.request<void>(`/notifications/threads/${id}/subscription`, {
        method: "DELETE",
        ...params,
      }),
    ...
    threadsSubscriptionDetail: (id: number, params: RequestParams = {}) =>
      this.request<Subscription>(`/notifications/threads/${id}/subscription`, {
        method: "GET",
        ...params,
      }),
  ...
  orgs = {
    ...
    orgsDetail: (org: string, params: RequestParams = {}) =>
      this.request<Organization>(`/orgs/${org}`, {
        method: "GET",
        ...params,
      }),
    ...
    eventsDetail: (org: string, params: RequestParams = {}) =>
      this.request<Events>(`/orgs/${org}/events`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesDetail: (
      ...
      this.request<Issues>(`/orgs/${org}/issues`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    membersDetail: (org: string, params: RequestParams = {}) =>
      this.request<Users>(`/orgs/${org}/members`, {
        method: "GET",
        ...params,
      }),
    ...
    membersDelete: (org: string, username: string, params: RequestParams = {}) =>
      this.request<void>(`/orgs/${org}/members/${username}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    publicMembersDetail: (org: string, params: RequestParams = {}) =>
      this.request<Users>(`/orgs/${org}/public_members`, {
        method: "GET",
        ...params,
      }),
    ...
    publicMembersDelete: (org: string, username: string, params: RequestParams = {}) =>
      this.request<void>(`/orgs/${org}/public_members/${username}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    reposDetail: (
      ...
      this.request<Repos>(`/orgs/${org}/repos`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    teamsDetail: (org: string, params: RequestParams = {}) =>
      this.request<Teams>(`/orgs/${org}/teams`, {
        method: "GET",
        ...params,
      }),
    ...
    teamsCreate: (org: string, body: OrgTeamsPost, params: RequestParams = {}) =>
      this.request<Team>(`/orgs/${org}/teams`, {
        method: "POST",
        body: body,
        ...params,
      }),
  ...
  rateLimit = {
    ...
    rateLimitList: (params: RequestParams = {}) =>
      this.request<RateLimit>(`/rate_limit`, {
        method: "GET",
        ...params,
      }),
  };
  repos = {
    ...
    reposDelete: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    assigneesDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Assignees>(`/repos/${owner}/${repo}/assignees`, {
        method: "GET",
        ...params,
      }),
    ...
    assigneesDetail2: (owner: string, repo: string, assignee: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/assignees/${assignee}`, {
        method: "GET",
        ...params,
      }),
    ...
    branchesDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Branches>(`/repos/${owner}/${repo}/branches`, {
        method: "GET",
        ...params,
      }),
    ...
    branchesDetail2: (owner: string, repo: string, branch: string, params: RequestParams = {}) =>
      this.request<Branch>(`/repos/${owner}/${repo}/branches/${branch}`, {
        method: "GET",
        ...params,
      }),
    ...
    collaboratorsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Users>(`/repos/${owner}/${repo}/collaborators`, {
        method: "GET",
        ...params,
      }),
    ...
    collaboratorsDelete: (owner: string, repo: string, user: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/collaborators/${user}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    commentsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<RepoComments>(`/repos/${owner}/${repo}/comments`, {
        method: "GET",
        ...params,
      }),
    ...
    commentsDelete: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/comments/${commentId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    commentsDetail2: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<CommitComment>(`/repos/${owner}/${repo}/comments/${commentId}`, {
        method: "GET",
        ...params,
      }),
    ...
    commitsDetail: (
      ...
      this.request<Commits>(`/repos/${owner}/${repo}/commits`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    commitsStatusDetail: (owner: string, repo: string, ref: string, params: RequestParams = {}) =>
      this.request<RefStatus>(`/repos/${owner}/${repo}/commits/${ref}/status`, {
        method: "GET",
        ...params,
      }),
    ...
    commitsDetail2: (owner: string, repo: string, shaCode: string, params: RequestParams = {}) =>
      this.request<Commit>(`/repos/${owner}/${repo}/commits/${shaCode}`, {
        method: "GET",
        ...params,
      }),
    ...
    commitsCommentsDetail: (owner: string, repo: string, shaCode: string, params: RequestParams = {}) =>
      this.request<RepoComments>(`/repos/${owner}/${repo}/commits/${shaCode}/comments`, {
        method: "GET",
        ...params,
      }),
    ...
    commitsCommentsCreate: (
      ...
      this.request<CommitComment>(`/repos/${owner}/${repo}/commits/${shaCode}/comments`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    compareDetail: (owner: string, repo: string, baseId: string, headId: string, params: RequestParams = {}) =>
      this.request<CompareCommits>(`/repos/${owner}/${repo}/compare/${baseId}...${headId}`, {
        method: "GET",
        ...params,
      }),
    ...
    contentsDelete: (owner: string, repo: string, path: string, body: DeleteFileBody, params: RequestParams = {}) =>
      this.request<DeleteFile>(`/repos/${owner}/${repo}/contents/${path}`, {
        method: "DELETE",
        body: body,
        ...params,
      }),
    ...
    contentsDetail: (
      ...
      this.request<ContentsPath>(`/repos/${owner}/${repo}/contents/${path}`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    contentsUpdate: (owner: string, repo: string, path: string, body: CreateFileBody, params: RequestParams = {}) =>
      this.request<CreateFile>(`/repos/${owner}/${repo}/contents/${path}`, {
        method: "PUT",
        body: body,
        ...params,
      }),
    ...
    contributorsDetail: (
      ...
      this.request<Users>(`/repos/${owner}/${repo}/contributors`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    deploymentsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<RepoDeployments>(`/repos/${owner}/${repo}/deployments`, {
        method: "GET",
        ...params,
      }),
    ...
    deploymentsCreate: (owner: string, repo: string, body: Deployment, params: RequestParams = {}) =>
      this.request<DeploymentResp>(`/repos/${owner}/${repo}/deployments`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    deploymentsStatusesDetail: (owner: string, repo: string, id: number, params: RequestParams = {}) =>
      this.request<DeploymentStatuses>(`/repos/${owner}/${repo}/deployments/${id}/statuses`, {
        method: "GET",
        ...params,
      }),
    ...
    deploymentsStatusesCreate: (
      ...
      this.request<void>(`/repos/${owner}/${repo}/deployments/${id}/statuses`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    downloadsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Downloads>(`/repos/${owner}/${repo}/downloads`, {
        method: "GET",
        ...params,
      }),
    ...
    downloadsDelete: (owner: string, repo: string, downloadId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/downloads/${downloadId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    downloadsDetail2: (owner: string, repo: string, downloadId: number, params: RequestParams = {}) =>
      this.request<Download>(`/repos/${owner}/${repo}/downloads/${downloadId}`, {
        method: "GET",
        ...params,
      }),
     ...
     */
    eventsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Events>(`/repos/${owner}/${repo}/events`, {
        method: "GET",
        ...params,
      }),
    ...
    forksDetail: (
      ...
      this.request<Forks>(`/repos/${owner}/${repo}/forks`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    forksCreate: (owner: string, repo: string, body: ForkBody, params: RequestParams = {}) =>
      this.request<Repo>(`/repos/${owner}/${repo}/forks`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitBlobsCreate: (owner: string, repo: string, body: Blob, params: RequestParams = {}) =>
      this.request<Blobs>(`/repos/${owner}/${repo}/git/blobs`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitBlobsDetail: (owner: string, repo: string, shaCode: string, params: RequestParams = {}) =>
      this.request<Blob>(`/repos/${owner}/${repo}/git/blobs/${shaCode}`, {
        method: "GET",
        ...params,
      }),
    ...
    gitCommitsCreate: (owner: string, repo: string, body: RepoCommitBody, params: RequestParams = {}) =>
      this.request<GitCommit>(`/repos/${owner}/${repo}/git/commits`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitCommitsDetail: (owner: string, repo: string, shaCode: string, params: RequestParams = {}) =>
      this.request<RepoCommit>(`/repos/${owner}/${repo}/git/commits/${shaCode}`, {
        method: "GET",
        ...params,
      }),
    ...
    gitRefsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Refs>(`/repos/${owner}/${repo}/git/refs`, {
        method: "GET",
        ...params,
      }),
    ...
    gitRefsCreate: (owner: string, repo: string, body: RefsBody, params: RequestParams = {}) =>
      this.request<HeadBranch>(`/repos/${owner}/${repo}/git/refs`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitRefsDelete: (owner: string, repo: string, ref: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/git/refs/${ref}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    gitRefsDetail2: (owner: string, repo: string, ref: string, params: RequestParams = {}) =>
      this.request<HeadBranch>(`/repos/${owner}/${repo}/git/refs/${ref}`, {
        method: "GET",
        ...params,
      }),
    ...
    gitTagsCreate: (owner: string, repo: string, body: TagBody, params: RequestParams = {}) =>
      this.request<Tag>(`/repos/${owner}/${repo}/git/tags`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitTagsDetail: (owner: string, repo: string, shaCode: string, params: RequestParams = {}) =>
      this.request<Tag>(`/repos/${owner}/${repo}/git/tags/${shaCode}`, {
        method: "GET",
        ...params,
      }),
    ...
    gitTreesCreate: (owner: string, repo: string, body: Tree, params: RequestParams = {}) =>
      this.request<Trees>(`/repos/${owner}/${repo}/git/trees`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    gitTreesDetail: (
      ...
      this.request<Tree>(`/repos/${owner}/${repo}/git/trees/${shaCode}`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    hooksDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Hook>(`/repos/${owner}/${repo}/hooks`, {
        method: "GET",
        ...params,
      }),
    ...
    hooksDelete: (owner: string, repo: string, hookId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/hooks/${hookId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    hooksDetail2: (owner: string, repo: string, hookId: number, params: RequestParams = {}) =>
      this.request<Hook>(`/repos/${owner}/${repo}/hooks/${hookId}`, {
        method: "GET",
        ...params,
      }),
    ...
    hooksTestsCreate: (owner: string, repo: string, hookId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/hooks/${hookId}/tests`, {
        method: "POST",
        ...params,
      }),
    ...
    issuesDetail: (
      ...
      this.request<Issues>(`/repos/${owner}/${repo}/issues`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    issuesCreate: (owner: string, repo: string, body: Issue, params: RequestParams = {}) =>
      this.request<Issue>(`/repos/${owner}/${repo}/issues`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    issuesCommentsDetail: (
      ...
      this.request<IssuesComments>(`/repos/${owner}/${repo}/issues/comments`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    issuesCommentsDelete: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/issues/comments/${commentId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    issuesCommentsDetail2: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<IssuesComment>(`/repos/${owner}/${repo}/issues/comments/${commentId}`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesEventsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<IssueEvents>(`/repos/${owner}/${repo}/issues/events`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesEventsDetail2: (owner: string, repo: string, eventId: number, params: RequestParams = {}) =>
      this.request<IssueEvent>(`/repos/${owner}/${repo}/issues/events/${eventId}`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesDetail2: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Issue>(`/repos/${owner}/${repo}/issues/${number}`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesCommentsDetail3: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<IssuesComments>(`/repos/${owner}/${repo}/issues/${number}/comments`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesCommentsCreate: (
      ...
      this.request<IssuesComment>(`/repos/${owner}/${repo}/issues/${number}/comments`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    issuesEventsDetail3: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<IssueEvents>(`/repos/${owner}/${repo}/issues/${number}/events`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesLabelsDelete: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/issues/${number}/labels`, {
        method: "DELETE",
        ...params,
      }),
    ...
    issuesLabelsDetail: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Labels>(`/repos/${owner}/${repo}/issues/${number}/labels`, {
        method: "GET",
        ...params,
      }),
    ...
    issuesLabelsCreate: (owner: string, repo: string, number: number, body: EmailsPost, params: RequestParams = {}) =>
      this.request<Label>(`/repos/${owner}/${repo}/issues/${number}/labels`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    issuesLabelsDelete2: (owner: string, repo: string, number: number, name: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/issues/${number}/labels/${name}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    keysDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Keys>(`/repos/${owner}/${repo}/keys`, {
        method: "GET",
        ...params,
      }),
    ...
    keysCreate: (owner: string, repo: string, body: UserKeysPost, params: RequestParams = {}) =>
      this.request<UserKeysKeyId>(`/repos/${owner}/${repo}/keys`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    keysDelete: (owner: string, repo: string, keyId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/keys/${keyId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    keysDetail2: (owner: string, repo: string, keyId: number, params: RequestParams = {}) =>
      this.request<UserKeysKeyId>(`/repos/${owner}/${repo}/keys/${keyId}`, {
        method: "GET",
        ...params,
      }),
    ...
    labelsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Labels>(`/repos/${owner}/${repo}/labels`, {
        method: "GET",
        ...params,
      }),
    ...
    labelsCreate: (owner: string, repo: string, body: EmailsPost, params: RequestParams = {}) =>
      this.request<Label>(`/repos/${owner}/${repo}/labels`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    labelsDelete: (owner: string, repo: string, name: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/labels/${name}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    labelsDetail2: (owner: string, repo: string, name: string, params: RequestParams = {}) =>
      this.request<Label>(`/repos/${owner}/${repo}/labels/${name}`, {
        method: "GET",
        ...params,
      }),
    ...
    languagesDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Languages>(`/repos/${owner}/${repo}/languages`, {
        method: "GET",
        ...params,
      }),
    ...
    mergesCreate: (owner: string, repo: string, body: MergesBody, params: RequestParams = {}) =>
      this.request<MergesSuccessful>(`/repos/${owner}/${repo}/merges`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    milestonesDetail: (
      ...
      this.request<Milestone>(`/repos/${owner}/${repo}/milestones`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    milestonesDelete: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/milestones/${number}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    milestonesDetail2: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Milestone>(`/repos/${owner}/${repo}/milestones/${number}`, {
        method: "GET",
        ...params,
      }),
    ...
    milestonesLabelsDetail: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Labels>(`/repos/${owner}/${repo}/milestones/${number}/labels`, {
        method: "GET",
        ...params,
      }),
    ...
    notificationsDetail: (
      ...
      this.request<Notifications>(`/repos/${owner}/${repo}/notifications`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    notificationsUpdate: (owner: string, repo: string, body: NotificationMarkRead, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/notifications`, {
        method: "PUT",
        body: body,
        ...params,
      }),
    ...
    pullsDetail: (
      ...
      this.request<Pulls>(`/repos/${owner}/${repo}/pulls`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    pullsCommentsDetail: (
      ...
      this.request<IssuesComments>(`/repos/${owner}/${repo}/pulls/comments`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    pullsCommentsDelete: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/pulls/comments/${commentId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    pullsCommentsDetail2: (owner: string, repo: string, commentId: number, params: RequestParams = {}) =>
      this.request<PullsComment>(`/repos/${owner}/${repo}/pulls/comments/${commentId}`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsDetail2: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<PullRequest>(`/repos/${owner}/${repo}/pulls/${number}`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsPartialUpdate: (owner: string, repo: string, number: number, body: PullUpdate, params: RequestParams = {}) =>
      this.request<Repo>(`/repos/${owner}/${repo}/pulls/${number}`, {
        method: "PATCH",
        body: body,
        ...params,
      }),
    ...
    pullsCommentsDetail3: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<PullsComment>(`/repos/${owner}/${repo}/pulls/${number}/comments`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsCommitsDetail: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Commits>(`/repos/${owner}/${repo}/pulls/${number}/commits`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsFilesDetail: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<Pulls>(`/repos/${owner}/${repo}/pulls/${number}/files`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsMergeDetail: (owner: string, repo: string, number: number, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/pulls/${number}/merge`, {
        method: "GET",
        ...params,
      }),
    ...
    pullsMergeUpdate: (owner: string, repo: string, number: number, body: MergePullBody, params: RequestParams = {}) =>
      this.request<Merge>(`/repos/${owner}/${repo}/pulls/${number}/merge`, {
        method: "PUT",
        body: body,
        ...params,
      }),
    ...
    readmeDetail: (
      ...
      this.request<ContentsPath>(`/repos/${owner}/${repo}/readme`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    releasesDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Releases>(`/repos/${owner}/${repo}/releases`, {
        method: "GET",
        ...params,
      }),
    ...
    releasesCreate: (owner: string, repo: string, body: ReleaseCreate, params: RequestParams = {}) =>
      this.request<Release>(`/repos/${owner}/${repo}/releases`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    releasesAssetsDelete: (owner: string, repo: string, id: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/releases/assets/${id}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    releasesAssetsDetail: (owner: string, repo: string, id: string, params: RequestParams = {}) =>
      this.request<Asset>(`/repos/${owner}/${repo}/releases/assets/${id}`, {
        method: "GET",
        ...params,
      }),
    ...
    releasesDelete: (owner: string, repo: string, id: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/releases/${id}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    releasesDetail2: (owner: string, repo: string, id: string, params: RequestParams = {}) =>
      this.request<Release>(`/repos/${owner}/${repo}/releases/${id}`, {
        method: "GET",
        ...params,
      }),
    ...
    releasesAssetsDetail2: (owner: string, repo: string, id: string, params: RequestParams = {}) =>
      this.request<Assets>(`/repos/${owner}/${repo}/releases/${id}/assets`, {
        method: "GET",
        ...params,
      }),
    ...
    stargazersDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Users>(`/repos/${owner}/${repo}/stargazers`, {
        method: "GET",
        ...params,
      }),
    ...
    statsCodeFrequencyDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<CodeFrequencyStats>(`/repos/${owner}/${repo}/stats/code_frequency`, {
        method: "GET",
        ...params,
      }),
    ...
    statsCommitActivityDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<CommitActivityStats>(`/repos/${owner}/${repo}/stats/commit_activity`, {
        method: "GET",
        ...params,
      }),
    ...
    statsContributorsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<ContributorsStats>(`/repos/${owner}/${repo}/stats/contributors`, {
        method: "GET",
        ...params,
      }),
    ...
    statsParticipationDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<ParticipationStats>(`/repos/${owner}/${repo}/stats/participation`, {
        method: "GET",
        ...params,
      }),
    ...
    statsPunchCardDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<CodeFrequencyStats>(`/repos/${owner}/${repo}/stats/punch_card`, {
        method: "GET",
        ...params,
      }),
    ...
    statusesDetail: (owner: string, repo: string, ref: string, params: RequestParams = {}) =>
      this.request<Ref>(`/repos/${owner}/${repo}/statuses/${ref}`, {
        method: "GET",
        ...params,
      }),
    ...
    subscribersDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Users>(`/repos/${owner}/${repo}/subscribers`, {
        method: "GET",
        ...params,
      }),
    ...
    subscriptionDelete: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<void>(`/repos/${owner}/${repo}/subscription`, {
        method: "DELETE",
        ...params,
      }),
    ...
    subscriptionDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Subscription>(`/repos/${owner}/${repo}/subscription`, {
        method: "GET",
        ...params,
      }),
    ...
    tagsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Tags>(`/repos/${owner}/${repo}/tags`, {
        method: "GET",
        ...params,
      }),
    ...
    teamsDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Teams>(`/repos/${owner}/${repo}/teams`, {
        method: "GET",
        ...params,
      }),
    ...
    watchersDetail: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<Users>(`/repos/${owner}/${repo}/watchers`, {
        method: "GET",
        ...params,
      }),
    ...
    reposDetail2: (
      ...
      this.request<any>(`/repos/${owner}/${repo}/${archiveFormat}/${path}`, {
        method: "GET",
        ...params,
      }),
  };
  repositories = {
    ...
    repositoriesList: (
      ...
      this.request<Repos>(`/repositories`, {
        method: "GET",
        query: query,
        ...params,
      }),
  ...
  search = {
    ...
    codeList: (
      ...
      this.request<SearchCode>(`/search/code`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    issuesList: (
      ...
      this.request<SearchIssues>(`/search/issues`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    repositoriesList: (
      ...
      this.request<SearchRepositories>(`/search/repositories`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    usersList: (
      ...
      this.request<SearchUsers>(`/search/users`, {
        method: "GET",
        query: query,
        ...params,
      }),
  ...
  teams = {
    ...
    teamsDelete: (teamId: number, params: RequestParams = {}) =>
      this.request<void>(`/teams/${teamId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    membersDetail: (teamId: number, params: RequestParams = {}) =>
      this.request<Users>(`/teams/${teamId}/members`, {
        method: "GET",
        ...params,
      }),
    ...
    membersDelete: (teamId: number, username: string, params: RequestParams = {}) =>
      this.request<void>(`/teams/${teamId}/members/${username}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    membershipsDelete: (teamId: number, username: string, params: RequestParams = {}) =>
      this.request<void>(`/teams/${teamId}/memberships/${username}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    membershipsDetail: (teamId: number, username: string, params: RequestParams = {}) =>
      this.request<TeamMembership>(`/teams/${teamId}/memberships/${username}`, {
        method: "GET",
        ...params,
      }),
    ...
    reposDetail: (teamId: number, params: RequestParams = {}) =>
      this.request<TeamRepos>(`/teams/${teamId}/repos`, {
        method: "GET",
        ...params,
      }),
    ...
    reposDelete: (teamId: number, owner: string, repo: string, params: RequestParams = {}) =>
      this.request<void>(`/teams/${teamId}/repos/${owner}/${repo}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    reposDetail2: (teamId: number, owner: string, repo: string, params: RequestParams = {}) =>
      this.request<any>(`/teams/${teamId}/repos/${owner}/${repo}`, {
        method: "GET",
        ...params,
      }),
  ...
  user = {
    ...
    emailsList: (params: RequestParams = {}) =>
      this.request<UserEmails>(`/user/emails`, {
        method: "GET",
        ...params,
      }),
    ...
    followersList: (params: RequestParams = {}) =>
      this.request<Users>(`/user/followers`, {
        method: "GET",
        ...params,
      }),
    ...
    followingList: (params: RequestParams = {}) =>
      this.request<Users>(`/user/following`, {
        method: "GET",
        ...params,
      }),
    ...
    followingDelete: (username: string, params: RequestParams = {}) =>
      this.request<void>(`/user/following/${username}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    issuesList: (
      ...
      this.request<Issues>(`/user/issues`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    keysList: (params: RequestParams = {}) =>
      this.request<Gitignore>(`/user/keys`, {
        method: "GET",
        ...params,
      }),
    ...
    keysCreate: (body: UserKeysPost, params: RequestParams = {}) =>
      this.request<UserKeysKeyId>(`/user/keys`, {
        method: "POST",
        body: body,
        ...params,
      }),
    ...
    keysDelete: (keyId: number, params: RequestParams = {}) =>
      this.request<void>(`/user/keys/${keyId}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    keysDetail: (keyId: number, params: RequestParams = {}) =>
      this.request<UserKeysKeyId>(`/user/keys/${keyId}`, {
        method: "GET",
        ...params,
      }),
    ...
    orgsList: (params: RequestParams = {}) =>
      this.request<Gitignore>(`/user/orgs`, {
        method: "GET",
        ...params,
      }),
    ...
    starredList: (
      ...
      this.request<Gitignore>(`/user/starred`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    starredDelete: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<void>(`/user/starred/${owner}/${repo}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    subscriptionsList: (params: RequestParams = {}) =>
      this.request<Repos>(`/user/subscriptions`, {
        method: "GET",
        ...params,
      }),
    ...
    subscriptionsDelete: (owner: string, repo: string, params: RequestParams = {}) =>
      this.request<void>(`/user/subscriptions/${owner}/${repo}`, {
        method: "DELETE",
        ...params,
      }),
    ...
    teamsList: (params: RequestParams = {}) =>
      this.request<TeamsList>(`/user/teams`, {
        method: "GET",
        ...params,
      }),
  };
  users = {
    ...
    usersDetail: (username: string, params: RequestParams = {}) =>
      this.request<User>(`/users/${username}`, {
        method: "GET",
        ...params,
      }),
    ...
    eventsDetail: (username: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/events`, {
        method: "GET",
        ...params,
      }),
    ...
    eventsOrgsDetail: (username: string, org: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/events/orgs/${org}`, {
        method: "GET",
        ...params,
      }),
    ...
    followersDetail: (username: string, params: RequestParams = {}) =>
      this.request<Users>(`/users/${username}/followers`, {
        method: "GET",
        ...params,
      }),
    ...
    followingDetail: (username: string, targetUser: string, params: RequestParams = {}) =>
      this.request<void>(`/users/${username}/following/${targetUser}`, {
        method: "GET",
        ...params,
      }),
    ...
    gistsDetail: (
      ...
      this.request<Gists>(`/users/${username}/gists`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    keysDetail: (username: string, params: RequestParams = {}) =>
      this.request<Gitignore>(`/users/${username}/keys`, {
        method: "GET",
        ...params,
      }),
    ...
    orgsDetail: (username: string, params: RequestParams = {}) =>
      this.request<Gitignore>(`/users/${username}/orgs`, {
        method: "GET",
        ...params,
      }),
    ...
    receivedEventsDetail: (username: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/received_events`, {
        method: "GET",
        ...params,
      }),
    ...
    receivedEventsPublicDetail: (username: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/received_events/public`, {
        method: "GET",
        ...params,
      }),
    ...
    reposDetail: (
      ...
      this.request<Repos>(`/users/${username}/repos`, {
        method: "GET",
        query: query,
        ...params,
      }),
    ...
    starredDetail: (username: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/starred`, {
        method: "GET",
        ...params,
      }),
    ...
    subscriptionsDetail: (username: string, params: RequestParams = {}) =>
      this.request<any>(`/users/${username}/subscriptions`, {
        method: "GET",
        ...params,
      }),
  };
