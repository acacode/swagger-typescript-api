...
const program = cli({
  ...
  options: [
    ...
    {
      flags: '--camelcase <string>',
      description: 'converts all properties key to camelCase',
      default: codeGenBaseConfig.camelcase,
    },
    {
    ...
    switch (command) {
      case null: {
        await generateApi({
          ...
          ...customConfig,
          hooks: options.camelcase && {
            onCreateComponent: (component) => {
              function mapEntries(object, mapCallbackFn) {
                return Object.fromEntries(
                  Object.entries(object).map(mapCallbackFn),
                );
              }
              ...
              component.rawTypeData = camelCaseProperties(
